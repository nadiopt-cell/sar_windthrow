...
OUT_BODY = f"{CACHE}/report_ed7_body.pdf"
OUT_FINAL = "/home/z/my-project/download/Сводный_отчет_объекты_валидации_изд7_2026-09-04.pdf"
COVER_PDF = f"{CACHE}/cover_ed7.pdf"
...
def main():
    ...
    story.extend(h1_block("8. Чувствительность к лесной маске фона (GFC@Y vs WC-2021)",
                          para(D.S7_P1)))
    ...
    story.extend(h1_block("9. Следующие шаги"))
